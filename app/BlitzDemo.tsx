...
const INITIAL_EMAILS: DemoEmail[] = [
  {
    ...
    preview: {
      ...
      en: "Please find our quote for the shaft attached. We can meet the deadline…",
      hu: "Mellékelten küldjük árajánlatunkat a tengelyre. A határidőt tudjuk tartani…",
    },
    time: "10:34",
    hasAttachment: true,
  ...
  },
  {
    ...
    subject: {
      de: "RE: Bestellung PO-2026-001",
      en: "RE: Order PO-2026-001",
      hu: "RE: Megrendelés PO-2026-001",
    },
    preview: {
    ...
    time: "09:20",
    hasAttachment: false,
    links: [{ label: "PO-2026-001", type: "po" }],
    status: "inbox",
  },
  {
    id: "3",
