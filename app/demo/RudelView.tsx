...
const CONVO: Record<Lang, { role: Role; text: string }[]> = {
  de: [
    { role: "meister", text: "Was ist der Status zu PO-2026-0018?" },
    { role: "gregor", text: "PO-2026-0018 (Nordmetall GmbH, 3.880 €) ist offen — 7 Positionen, noch nicht bestätigt. Liefertermin laut Projekt P26-014 ist der 9. Juni." },
    { role: "igor", text: "In der letzten Mail von Nordmetall steht eine Rückfrage zur Toleranz bei Position 4. Soll ich einen Antwortentwurf erstellen?" },
    { role: "meister", text: "Ja, und übersetz die Antwort auf Ungarisch für die Fertigung." },
    { role: "rosetta", text: "Erledigt — Antwort auf DE verfasst und nach HU übersetzt. Beide Versionen hängen am Task #35." },
  ],
  en: [
    { role: "meister", text: "What's the status on PO-2026-0018?" },
    { role: "gregor", text: "PO-2026-0018 (Nordmetall GmbH, €3,880) is open — 7 line items, not yet confirmed. Delivery date per project P26-014 is June 9." },
    { role: "igor", text: "The last email from Nordmetall has a query about the tolerance on line 4. Shall I draft a reply?" },
    { role: "meister", text: "Yes, and translate the reply to Hungarian for production." },
    { role: "rosetta", text: "Done — reply drafted in DE and translated to HU. Both versions attached to task #35." },
  ],
  hu: [
    { role: "meister", text: "Mi a státusza a PO-2026-0018-nak?" },
    { role: "gregor", text: "A PO-2026-0018 (Nordmetall GmbH, 3 880 €) nyitott — 7 tétel, még nincs megerősítve. A szállítási határidő a P26-014 projekt szerint június 9." },
    { role: "igor", text: "A Nordmetall utolsó emailjében van egy kérdés a 4. tétel tűréséről. Készítsek választervezetet?" },
    { role: "meister", text: "Igen, és fordítsd le a választ magyarra a gyártásnak." },
    { role: "rosetta", text: "Kész — válasz DE-n megfogalmazva és HU-ra fordítva. Mindkét verzió a #35 feladathoz csatolva." },
  ],
};
