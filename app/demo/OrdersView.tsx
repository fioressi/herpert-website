...
const ORDERS: DemoOrder[] = [
  { id: "PO-2026-0021", supplier: "Präzitec Kft.", project: "P26-014", total: "1.240", status: "confirmed", lines: 3 },
  { id: "PO-2026-0018", supplier: "Nordmetall GmbH", project: "P26-014", total: "3.880", status: "open", lines: 7 },
  { id: "PO-2026-0009", supplier: "FeinTech Kft.", project: "P26-021", total: "980", status: "delivered", lines: 2 },
  { id: "PO-2026-0024", supplier: "Stahlwerk Auer AG", project: "P26-009", total: "5.640", status: "open", lines: 4 },
];

const RFQS: DemoRfq[] = [
  { id: "RFQ-2026-034", part: "Halteblech", partId: "H-7206-14021-90", suppliers: 3, bestQuote: "1.180", status: "quoted" },
  { id: "RFQ-2026-031", part: "Lagerbock", partId: "H-7205-14008-80", suppliers: 4, bestQuote: "640", status: "awarded" },
  { id: "RFQ-2026-029", part: "Greifmodul X3", partId: "H-7014-14033-70", suppliers: 2, bestQuote: null, status: "sent" },
  { id: "RFQ-2026-027", part: "Deckblech", partId: "H-7206-14041-50", suppliers: 0, bestQuote: null, status: "draft" },
];
